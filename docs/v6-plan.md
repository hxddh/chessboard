...
| Q3.2 题库管线 | **部分** | `import-puzzles.mjs` + `puzzle-gate.mjs` 管线完成并有样本测试，但本机不可达 `database.lichess.org`，Lichess 题未入库。改走第二来源：`mine-puzzles.mjs` 引擎自弈挖题（900 局），过同一套门禁并经引擎复核，入库 958 题（一步杀 42 · 两步杀 27 · 三步杀 49 · 吃子 300 · 战术 540，其中捉双 125 · 牵制 106 · 串击 48 · 闪击 7 · 双将 10）。「每母题 ≥ 100 题」捉双与牵制已达；串击 / 闪击 / 双将在自弈里天然稀少，未达 |
