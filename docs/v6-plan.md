...
| Q3.2 题库管线 | **部分** | `import-puzzles.mjs` + `puzzle-gate.mjs` 管线完成并有样本测试，但本机不可达 `database.lichess.org`，Lichess 题未入库。改走第二来源：`mine-puzzles.mjs` 引擎自弈挖题（450 局），过同一套门禁并经引擎复核，入库 787 题（一步杀 24 · 两步杀 19 · 三步杀 25 · 吃子 300 · 战术 419，其中捉双 94 · 牵制 82 · 串击 39 · 闪击 8 · 双将 6）。「每母题 ≥ 100 题」只差捉双与牵制不远，串击 / 闪击 / 双将在自弈里天然稀少，未达 |
