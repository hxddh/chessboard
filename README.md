...
| **做题练习** | 侧栏「模式 → 做题」：**一步杀 / 两步杀 / 三步杀 / 吃子 / 战术母题 / 开局 / 复习**七类题库(148 题)（底线杀、闷杀、肩章杀、阿拉伯杀、达米亚诺杀、升变杀、弃后引杀、双车赶王、**后王/车王逼角、升变三步杀**…）；答错回退并**说明黑方如何化解**;「答案」画正解箭头;杀王题接受任何可强制将死的替代解;吃子题选净得子力最多的一吃;战术母题(**串击/闪将/牵制/捉双**)强制得子;**难度分级(简单/中等/较难)** 由解法长度、子力密度与首着是否安静着自动推导,可按难度筛选(简单 51 / 中等 45 / 较难 14),筛选结果会记住;开局题执白照谱背 38 条主流线路,**每条附思路讲解**;**答错或看答案的题自动进「复习」,做对即移出**；进度持久 |
...
src/web/
  ...
  js/puzzles.js    # 题库 110 题:杀王/吃子/战术母题(求解器证明强制),另 38 条开局线路
  ...
  js/i18n.js       # 界面文案字典 zh-CN / en 各 461 条(单测校验键完整、无漏译、
