...
src/web/
  ...
  js/lessons.js    # 零基础教学课程 67 课（单测逐课校验 FEN/解法/目标）
  js/puzzles.js    # 题库 164 题:杀王/吃子/战术母题(求解器证明强制)/实战/防守/求和,另 111 条开局线路
  ...
  js/i18n.js       # 界面文案字典 zh-CN / en / ja 各 596 条(单测校验键完整、无漏译、
