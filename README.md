...
| **做题练习** | 侧栏「模式 → 做题」：**一步杀 / 两步杀 / 三步杀 / 吃子 / 战术母题 / 开局 / 复习**七类题库(58 题)（底线杀、闷杀、肩章杀、阿拉伯杀、升变杀、弃后引杀、双车赶王、**后王/车王逼角、升变三步杀**…）；答错回退并**说明黑方如何化解**;「答案」画正解箭头;杀王题接受任何可强制将死的替代解;吃子题选净得子力最多的一吃;战术母题(**串击/闪将/牵制/捉双**)强制得子;开局题执白照谱背 38 条主流线路,**每条附思路讲解**;**答错或看答案的题自动进「复习」,做对即移出**；进度持久 |
...
| **局面编辑 / FEN** | 棋谱区「编辑局面」摆子开局（棋子调色板 · 走子方 · 易位权 · 清空/初始,**合法性实时校验**）；「载入 FEN」从文本或剪贴板载入局面 |
...
| 侧栏 | **Tab** 开关；主题 木/夜/日/纸 · **界面语言 中文/English**（课程与题库内容仍为中文）· 音效开关 |
...
- **后续**：课程与题库内容多语言化、题目难度分级、更多开局体系讲解
...
src/web/
  ...
  js/i18n.js       # 界面文案字典 zh-CN / en(单测校验各语言键完整)
