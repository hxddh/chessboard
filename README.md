...
| 侧栏 | **Tab** 开关；主题 木/夜/日/纸 · **界面语言 中文/English**（**全部界面、状态、提示、播报、36 课教学、题库与开局名称均已本地化**；实测英文模式下各视图可见中文串数为 0）· 音效开关 |
...
src/web/
  ...
  js/i18n.js       # 界面文案字典 zh-CN / en 各 494 条(单测校验键完整、无漏译、
                   #   tooltip 与 aria-label 全接线、app.js 无中文字面量进 DOM)
  js/lessons-en.js # 教学课文英文全译 36 课(仅文案;局面与解法仍只来自 lessons.js)
  js/puzzles-en.js # 题名英文(仅文案;FEN/解法/得分仍只来自 puzzles.js)
  js/openings-en.js# 开局名英文(以中文名为键;ECO 与着法序列仍只来自 openings.js)
