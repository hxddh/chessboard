 ...
 */
  const DICT = {
    "zh-CN": {
      ...
      "side.personaNote": "风格叠加在难度之上 —— 换风格不改变棋力,只改变它偏爱哪种着法",
      ...
      "tip.diff.extreme": "Stockfish 满强度",
      "tip.cat.m1": "一步将死",
      ...
      "tip.accuracy": "由平均失分换算的近似准确率,非官方评级",
    ...
    en: {
      ...
      "side.personaNote": "Style sits on top of the level — it changes what the engine likes to play, not how strong it is",
      ...
      "diff.hard": "Advanced", "diff.extreme": "Full strength",
      ...
      "tip.diff.extreme": "Stockfish at full strength",
      ...
      "tip.accuracy": "Approximate accuracy derived from average centipawn loss — not an official rating",
    ...
    ja: {
      ...
      "side.personaNote": "スタイルは強さの上に重なる —— 棋力は変わらず、どんな手を好むかだけが変わる",
      ...
      "diff.hard": "上級", "diff.extreme": "フルパワー",
      ...
      "tip.accuracy": "平均損失から換算した目安の正確度です。公式レーティングではありません",
