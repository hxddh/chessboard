 ...
 */
  const DICT = {
    "zh-CN": {
      ...
      "about.licenseText": "GPLv3 —— 自由软件，源码随发布提供", "about.creditsText": "Stockfish 19（GPLv3）· chess.js（BSD-2）· cburnett 棋子矢量（GFDL / BSD / GPL / CC BY-SA 3.0 多重许可）· Merida 棋子（Armando Hernandez Marroquin，GPLv2+）· lichess chess-openings（CC0）",
      ...
      "side.volume": "音量", "tip.volume": "音效音量", "side.coords": "坐标", "tip.coords": "在棋盘边框上标出 a–h 与 1–8", "side.softMark": "存疑标注", "tip.softMark": "复盘里显示 ?! —— 同一局面跑两遍只有约一半重合，默认不显示", "side.blindfold": "盲棋", "tip.blindfold": "不画棋子，只画标记 —— 靠记忆下",
    ...
    en: {
      ...
      "about.licenseText": "GPLv3 — free software; the source ships with every release", "about.creditsText": "Stockfish 19 (GPLv3) · chess.js (BSD-2) · cburnett piece set (multi-licensed GFDL / BSD / GPL / CC BY-SA 3.0) · Merida piece set (Armando Hernandez Marroquin, GPLv2+) · lichess chess-openings (CC0)",
    ...
    ja: {
      ...
      "about.licenseText": "GPLv3 —— 自由ソフトウェア。ソースコードは各リリースに付属", "about.creditsText": "Stockfish 19（GPLv3）· chess.js（BSD-2）· cburnett 駒セット（GFDL / BSD / GPL / CC BY-SA 3.0 の複数ライセンス）· Merida 駒セット（Armando Hernandez Marroquin、GPLv2+）· lichess chess-openings（CC0）",
      ...
      "side.volume": "ボリューム", "tip.volume": "効果音の音量", "side.coords": "座標", "tip.coords": "盤の枠に a–h と 1–8 を表示", "side.softMark": "疑問符の表示", "tip.softMark": "検討で ?! を表示する —— 同じ局面を二度調べても一致するのは約半分なので既定では非表示", "side.blindfold": "目隠しチェス", "tip.blindfold": "駒を描かず印だけ描く —— 記憶で指す",
