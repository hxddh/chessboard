 ...
 */
  const DICT = {
    "zh-CN": {
      ...
      "pz.smart.rated": "一道和你评级相当的题（{0}）", "pz.rating": "评级", "pz.ratingOf": "题目 {0}", "rec.rating": "做题评级", "rec.ratingRd": "±{0}", "aria.trendRating": "做题评级走势", "tip.trendRating": "最近 60 次首答后的评级",
      "rec.due": "复习到期 {0} · 明天 {1}",
    ...
    en: {
      ...
      "pz.smart.rated": "A puzzle at your level ({0})", "pz.rating": "Rating", "pz.ratingOf": "Puzzle {0}", "rec.rating": "Puzzle rating", "rec.ratingRd": "±{0}", "aria.trendRating": "Puzzle rating trend", "tip.trendRating": "Your rating after each of the last 60 first attempts",
    ...
    ja: {
      ...
      "pz.smart.rated": "あなたのレーティングに合った問題（{0}）", "pz.rating": "レーティング", "pz.ratingOf": "問題 {0}", "rec.rating": "パズルのレーティング", "rec.ratingRd": "誤差 ±{0}", "aria.trendRating": "パズルレーティングの推移", "tip.trendRating": "直近 60 回の初回解答後のレーティング",
