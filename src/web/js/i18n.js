 ...
 */
  const DICT = {
    "zh-CN": {
      ...
      "msg.profile.restored": "已从本机数据文件恢复档案，正在重新载入…",
      "about.title": "关于国际象棋", "about.version": "版本", "about.license": "许可", "about.source": "源码", "about.credits": "致谢", "about.dataPath": "数据位置",
      "about.licenseText": "GPLv3 —— 自由软件，源码随发布提供", "about.creditsText": "Stockfish 18（GPLv3）· chess.js（BSD-2）· cburnett 棋子矢量（GFDL / BSD / GPL / CC BY-SA 3.0 多重许可）· lichess chess-openings（CC0）",
      ...
      "side.volume": "音量", "tip.volume": "音效音量", "side.coords": "坐标", "tip.coords": "在棋盘边框上标出 a–h 与 1–8", "side.blindfold": "盲棋", "tip.blindfold": "不画棋子，只画标记 —— 靠记忆下",
    ...
    en: {
      ...
      "msg.profile.restored": "Profile restored from the local data file — reloading…",
      ...
      "about.licenseText": "GPLv3 — free software; the source ships with every release", "about.creditsText": "Stockfish 18 (GPLv3) · chess.js (BSD-2) · cburnett piece set (multi-licensed GFDL / BSD / GPL / CC BY-SA 3.0) · lichess chess-openings (CC0)",
      ...
      "side.volume": "Volume", "tip.volume": "Sound volume", "side.coords": "Coordinates", "tip.coords": "Print a–h and 1–8 on the board frame", "side.blindfold": "Blindfold", "tip.blindfold": "Hide the pieces, keep the marks — play from memory",
    ...
    ja: {
      ...
      "msg.profile.restored": "端末のデータファイルからプロファイルを復元しました。再読み込みします…",
      "about.title": "このアプリについて", "about.version": "バージョン", "about.license": "ライセンス", "about.source": "ソースコード", "about.credits": "謝辞", "about.dataPath": "データの場所",
      "about.licenseText": "GPLv3 —— 自由ソフトウェア。ソースコードは各リリースに付属", "about.creditsText": "Stockfish 18（GPLv3）· chess.js（BSD-2）· cburnett 駒セット（GFDL / BSD / GPL / CC BY-SA 3.0 の複数ライセンス）· lichess chess-openings（CC0）",
      ...
      "side.volume": "ボリューム", "tip.volume": "効果音の音量", "side.coords": "座標", "tip.coords": "盤の枠に a–h と 1–8 を表示", "side.blindfold": "目隠しチェス", "tip.blindfold": "駒を描かず印だけ描く —— 記憶で指す",
