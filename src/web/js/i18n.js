 ...
 */
  const DICT = {
    "zh-CN": {
      ...
      "about.licenseText": "GPLv3 —— 自由软件，源码随发布提供", "about.creditsText": "Stockfish 19（GPLv3）· chess.js（BSD-2）· cburnett 棋子矢量（GFDL / BSD / GPL / CC BY-SA 3.0 多重许可）· lichess chess-openings（CC0）· Lucide 图标（ISC；其中 10 个源自 Feather，MIT）",
    ...
    en: {
      ...
      "about.licenseText": "GPLv3 — free software; the source ships with every release", "about.creditsText": "Stockfish 19 (GPLv3) · chess.js (BSD-2) · cburnett piece set (multi-licensed GFDL / BSD / GPL / CC BY-SA 3.0) · lichess chess-openings (CC0) · Lucide icons (ISC; ten derived from Feather, MIT)",
      // 7.7 (v7-7-plan §2–§4, §7): the result card, the puzzle feedback card,
      // the lesson dots and the tool row's tooltips
    ...
    ja: {
      ...
      "about.licenseText": "GPLv3 —— 自由ソフトウェア。ソースコードは各リリースに付属", "about.creditsText": "Stockfish 19（GPLv3）· chess.js（BSD-2）· cburnett 駒セット（GFDL / BSD / GPL / CC BY-SA 3.0 の複数ライセンス）· lichess chess-openings（CC0）· Lucide アイコン（ISC。うち 10 個は Feather 由来で MIT）",
      // 7.7 (v7-7-plan §2–§4, §7): the result card, the puzzle feedback card,
      // the lesson dots and the tool row's tooltips
      "go.analyse": "この対局を解析",
      "go.again": "もう一局",
