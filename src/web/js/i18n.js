 ...
 */
  const DICT = {
    "zh-CN": {
      ...
      "side.volume": "音量", "tip.volume": "音效音量", "side.soundSet": "音色", "tip.soundSet": "木质：木头棋子落在木头棋盘上；经典：7.6 以前的合成音", "soundSet.wood": "木质", "soundSet.classic": "经典", "side.coords": "坐标", "tip.coords": "在棋盘边框上标出 a–h 与 1–8", "side.softMark": "存疑标注", "tip.softMark": "复盘里显示 ?! —— 同一局面跑两遍只有约一半重合，默认不显示", "side.blindfold": "盲棋", "tip.blindfold": "不画棋子，只画标记 —— 靠记忆下",
