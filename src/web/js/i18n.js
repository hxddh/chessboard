 ...
 */
  const DICT = {
    ...
    ja: {
      ...
      "keys.step": "棋譜送り：1 手戻る / 1 手進む（カーソルモードではカーソル移動）", "keys.ends": "棋譜送り：開始局面へ / 最新手へ（カーソルモードでは盤の隅へ）",
      ...
      "keys.board": "盤カーソルモード：Tab で盤へ移るか Enter で開始。方向キーでカーソル移動、Enter で持ち上げ・着手、Esc で抜ける",
