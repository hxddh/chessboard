...
(function (global) {
  const DICT = {
    "zh-CN": {
      ...
      "aria.tabs": "面板分区", "tip.collapse": "收起侧栏 (P)",
      ...
      "tip.60": "防守:黑方下一步就要将死,找出接得住的一手",
      "tip.61": "求和:已经必败,逼成僵局或长将保住半分",
      "tip.62": "不加风格,引擎按难度正常发挥",
      "tip.63": "见子就吃,会主动踩进你的捉双和牵制",
      "tip.64": "按开局三原则出子:抢中心、快出轻子、尽早易位",
      "tip.65": "子力一直往你的王那边压(实测每一手都落在你王三格以内),练防守用",
      "tip.60": "走子音效",
      "tip.61": "进入下一课",
      "tip.62": "重做本课任务 (R)",
      "tip.63": "重新开始本题 (R)",
    ...
    en: {
      ...
      "diff.beginner": "Beginner", "diff.easy": "Novice", "diff.normal": "Intermediate",
      "diff.casual": "Casual",
      ...
      "aria.tabs": "Panel sections", "tip.collapse": "Collapse the side panel (P)",
      ...
      "tip.60": "Defence: Black mates next move — find the way to stop it",
      "tip.61": "Saves: the game is lost; hold the draw by stalemate or perpetual check",
      "tip.62": "No style applied — the engine plays its rating straight",
      "tip.63": "Takes everything it can, and walks into your forks and pins",
      "tip.64": "Plays the opening by the book: centre, minor pieces, castle early",
      "tip.65": "Keeps piling pieces onto your king — measured, every move lands within three squares of it. Practice for defending",
      "tip.60": "Move sounds",
    ...
    ja: {
      ...
      "aria.tabs": "パネルの区分", "tip.collapse": "サイドパネルをたたむ (P)",
      ...
      "tip.60": "受け:次に黒が詰ませてきます。受けの一手を見つけましょう",
      "tip.61": "引き分け狙い:負け局面から、ステイルメイトか連続王手で半分を確保します",
      "tip.62": "クセなし。エンジンは強さ設定どおりに指します",
      "tip.63": "取れる駒は取りにきます。あなたのフォークやピンに自分から飛び込みます",
      "tip.64": "定石どおりの序盤:中央を取り、軽い駒から出し、早めにキャスリング",
      "tip.65": "駒を王のほうへ寄せ続けます(実測では毎手が王から3マス以内)。受けの練習に",
      "tip.60": "着手音",
      "tip.61": "次のレッスンへ進みます",
      "tip.62": "この課題をやり直す (R)",
      "tip.63": "この問題をやり直す (R)",
