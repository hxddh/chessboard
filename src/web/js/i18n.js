 ...
 */
  const DICT = {
    "zh-CN": {
      ...
      "about.licenseText": "GPLv3 —— 自由软件，源码随发布提供", "about.creditsText": "Stockfish 19（GPLv3）· chess.js（BSD-2）· cburnett 棋子矢量（GFDL / BSD / GPL / CC BY-SA 3.0 多重许可）· lichess chess-openings（CC0）",
    ...
    en: {
      ...
      "about.licenseText": "GPLv3 — free software; the source ships with every release", "about.creditsText": "Stockfish 19 (GPLv3) · chess.js (BSD-2) · cburnett piece set (multi-licensed GFDL / BSD / GPL / CC BY-SA 3.0) · lichess chess-openings (CC0)",
    ...
    ja: {
      ...
      "about.licenseText": "GPLv3 —— 自由ソフトウェア。ソースコードは各リリースに付属", "about.creditsText": "Stockfish 19（GPLv3）· chess.js（BSD-2）· cburnett 駒セット（GFDL / BSD / GPL / CC BY-SA 3.0 の複数ライセンス）· lichess chess-openings（CC0）",
