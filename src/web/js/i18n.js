 ...
 */
  const DICT = {
    "zh-CN": {
      ...
      "about.licenseText": "GPLv3 —— 自由软件，源码随发布提供", "about.creditsText": "Stockfish 19（GPLv3）· chess.js（BSD-2）· cburnett 棋子矢量（GFDL / BSD / GPL / CC BY-SA 3.0 多重许可）· Merida 棋子（Armando Hernandez Marroquin，GPLv2+）· lichess chess-openings（CC0）· 木质音效为本项目自制（物理模型实时合成，GPLv3）· Lucide 图标（ISC；其中 10 个源自 Feather，MIT）",
      ...
      "rv.turningPoint": "关键一步：第 {0} 回合 {1} 走 {2}，胜率掉了 {3} 个百分点 —— 点此跳转",
      ...
      "side.pieces": "棋子样式", "pieces.cburnett": "标准", "pieces.merida": "梅里达",
      ...
      "rec.emptyLead": "这一页记的是你下过的棋：战绩、每局的棋谱、十五个成就。现在还空着 —— 下面三件事，每件都开一个头。",
    ...
    en: {
      ...
      "side.learning": "Learning data", "act.learningExport": "Export", "act.learningImport": "Import",
      "side.allData": "All data", "act.allExport": "Export", "act.allImport": "Import", "act.about": "About",
      "tip.allData.export": "Save everything on this device (game, slots, settings, record, learning data) as one file", "tip.allData.import": "Replace this device's data with an exported file", "tip.about": "Version, licence and credits",
      ...
      "about.licenseText": "GPLv3 — free software; the source ships with every release", "about.creditsText": "Stockfish 19 (GPLv3) · chess.js (BSD-2) · cburnett piece set (multi-licensed GFDL / BSD / GPL / CC BY-SA 3.0) · Merida piece set (Armando Hernandez Marroquin, GPLv2+) · lichess chess-openings (CC0) · wooden sound set made for this project (rendered from a physical model, GPLv3) · Lucide icons (ISC; ten derived from Feather, MIT)",
      // 7.7 (v7-7-plan §2–§4, §7): the result card, the puzzle feedback card,
      // the lesson dots and the tool row's tooltips
      ...
      "go.draw": "Draw",
      "go.r.mate": "Checkmate",
      "go.r.flag": "{0} ran out of time",
      "go.r.flagDraw": "Time out · the other side cannot mate",
      "go.r.resign": "{0} resigned",
      "go.r.agreed": "Draw agreed",
      "go.r.threefold": "Claimed · threefold repetition",
      "go.r.fifty": "Claimed · 50 moves without a capture or pawn move",
      "go.r.stalemate": "Stalemate",
      "go.r.insufficient": "Neither side can mate",
      "go.r.fivefold": "Fivefold repetition",
      "go.r.seventyfive": "75 moves without a capture or pawn move",
      "go.r.file": "Result as recorded in the file",
      "pz.fb.best": "Best move!",
      "pz.fb.keepGoing": "Right — keep going",
      "pz.fb.retry": "Think again",
      "pz.fb.streak": "{0} in a row",
      ...
      "msg.menuLang.restart": "The menu language takes effect at the next launch", "app.title": "Chessboard",
      "side.volume": "Volume", "tip.volume": "Sound volume", "side.soundSet": "Sound set", "tip.soundSet": "Wood: wooden pieces on a wooden board. Classic: the synthesised sounds from before 7.7", "soundSet.wood": "Wood", "soundSet.classic": "Classic", "side.coords": "Coordinates", "tip.coords": "Print a–h and 1–8 on the board", "side.coordsAt": "Coordinates at", "coords.out": "Outside", "coords.in": "Inside", "side.softMark": "Dubious marks", "tip.softMark": "Show ?! in the review — two runs over the same position agree about half the time, so it is off by default", "side.blindfold": "Blindfold", "tip.blindfold": "Hide the pieces, keep the marks — play from memory", "side.engineArrows": "Engine arrows", "tip.engineArrows": "During live analysis and the review, draw the first move of the engine's top three lines as arrows on the board",
      "msg.blind.on": "Blindfold: pieces hidden", "msg.blind.off": "Pieces shown",
      "side.engine": "Engine", "side.hash": "Hash table", "tip.hash": "Engine hash table size (MB)", "side.multipv": "Analysis lines", "tip.multipv": "How many variations the review and the live analysis give at once",
      "tip.learning.export": "Save the personal book, review queue, lesson progress and record as one file", "tip.learning.import": "Merge a previously exported file back in; nothing already here is overwritten",
      "dlg.exportLearning": "Export learning data", "dlg.importLearning": "Import learning data: merged with what is already here, overwriting neither.",
      "msg.learning.badFile": "That is not a learning-data file exported by this app", "msg.learning.imported": "Merged — the personal book now holds {0} drills",
      ...
      "msg.storage.corrupt": "One record could not be read ({0}). It has been set aside as it was, not overwritten; Settings → All data → Export carries it along.",
      "msg.fault.happened": "Something went wrong — the game has been saved. If it happens again, copy the diagnostics and report it.", "msg.fault.copy": "Copy diagnostics", "msg.fault.copied": "Diagnostics copied",
      "lang.name": "English",
      // first-run onboarding (ob.*)
      ...
      "rv.turningPoint": "Turning point: move {0}, {1} played {2}, dropping the win chance by {3} points — tap to jump",
      "rv.turningPointPlain": "Turning point: move {0}, {1} played {2}, dropping the win chance by {3} points",
      "rv.jumpTip": "Jump to the position after this move",
      "rv.bank": "Bank this move as a drill",
      "rv.bankTip": "Add this turning point to My mistakes, same rules as the automatic miner",
      "ex.mate1": "Missed mate in one: {0}",
      "ex.mateN": "Missed mate in {1} starting with {0}",
      "ex.allowsMate": "Allows mate in {1} starting with {0}",
      "ex.allowsMate1": "Allows mate in one: {0}",
      "ex.motifLoss": "Missed {0} ({1}), losing the {2}",
      "ex.motif": "Missed {0} ({1})",
      "ex.forkHits": "Missed {0} ({1}), hitting the {2} and the {3}",
      "ex.loss": "After {0} the {1} is lost",
      "ex.betterMotif": "Better was {0} ({1})",
      "ex.better": "Better was {0}",
      "rv.mistakes": "Mistakes",
      "rv.retry": "Try again",
      "rt.ask": "Try again: move {0}, what should {1} play?",
      "rt.checking": "The engine is judging this move…",
      "rt.right": "Correct",
      "rt.wrong": "Not this one",
      "rt.best": "Engine's best: {0}",
      "rt.again": "Try once more",
      "rt.back": "Back to the review",
      "rt.noEngine": "The engine is not ready, so this move cannot be judged",
      "rv.banked": "Banked · the answer is {0}",
      "rv.bankDup": "This move is already in My mistakes",
      "rv.bankNone": "The engine agrees with what was played — nothing to drill",
      ...
      "ntf.libraryTitle": "Game library",
      "ntf.libraryBody": "Analysed {0} of {1}",
      "ntf.libraryDone": "{0:game|games} analysed",
      ...
      "mm.blunder": "{0} may have been a serious mistake — press Z to take it back",
      ...
      "msg.pgnLocked": "Analysis is running — changing the game now would throw it away. Stop the analysis first",
      ...
      "pz.cat.mine": "My mistakes",
      "tip.cat.mine": "Your own ?? moves from analysed games — set up again, find the right move this time",
      "pz.goalMine": "In the game you played {0} — find the stronger move",
      "pz.mineCost": "it cost {0} pawns",
      "pz.mineName": "Mistake {0} · move {1}",
      "pz.mine.repeat": "That is exactly the move that lost the game its edge",
      ...
      "daily.lesson": "Learn a new lesson",
      "daily.op": "One opening line",
      "daily.lib": "Analyse the {0:game|games} your library still owes",
      "daily.game": "Play a game",
      "daily.rest": "Nothing owed and nothing untouched — free practice, or just play",
      "daily.begin": "{0} steps this sitting — starting with the first",
      "daily.done": "Session complete",
      "daily.streak": "{0}-day streak",
      "daily.planAria": "The steps of this session",
      "daily.why.review": "review due", "daily.why.mine": "a position you got wrong", "daily.why.weak": "your weakest category",
      "daily.why.lesson": "the next lesson", "daily.why.op": "an opening not yet learned", "daily.why.game": "no game played today",
      "daily.why.motif": "a motif you keep missing",
      "side.trend": "Progress",
      "aria.trendAcc": "Accuracy over time",
      "tip.trendAcc": "Accuracy of recently analysed games, in play order",
      "trend.row": "solved {0} this week · {1} last week",
      "trend.rowNew": "solved {0} this week",
      "trend.rowPrev": "solved {0} last week · none answered yet this week",
      "trend.mines": "banked {0} · redeemed {1} this week",
      ...
      "pz.smart": "Pick for me", "tip.puzzle.smart": "Chooses by your review debt and miss rates",
      "pz.smart.review": "Review first: {0} still owed",
      "pz.smart.weak": "\u201c{0}\u201d is where you miss most",
      ...
      "study.part": "Classic games", "study.head": "Reading a game", "study.intro": "{0}, {1} · {2} · result {3}. Step through with ← →; the notes appear with the moves, and you can try another move at any point.", "study.noNote": "(no note on this move)", "study.of": "Move {0}",
      ...
      "side.pieces": "Piece set", "pieces.cburnett": "Standard", "pieces.merida": "Merida",
      ...
      "ach.more": "{0} more", "ach.less": "Show fewer",
      "rec.emptyLead": "This page keeps what you have played: your record, the movetext of every game, fifteen badges. It is empty — each of the three below opens one.",
      "rec.goLearn": "Take lesson 1", "rec.goPuzzle": "Solve a tactics puzzle", "rec.goPlay": "Play the engine",
      "rec.unlocks": "Unlocks “{0}”", "rec.winUnlocks": "Win it to unlock “{0}”",
      ...
      "color.white": "White", "color.black": "Black", "color.random": "Random", "ng.title": "New game", "ng.endsCurrent": "This ends the game in progress", "ng.start": "Start", "ng.pvpColor": "Bottom side plays",
      "clock.off": "No clock",
      ...
      "act.restart": "Restart", "act.retry": "Retry", "act.demo": "Demo", "act.next": "Next lesson",
      "act.practice": "Practise ({0})",
      "act.puzzleRetry": "Retry", "act.puzzleNext": "Next puzzle",
      "turn.white": "White to move", "turn.black": "Black to move", "turn.check": "Check!",
      "vs.white": "W", "vs.black": "B", "vs.p1": "Player 1", "vs.p2": "Player 2",
      ...
      "st.result10": "1-0 · White wins", "st.result01": "0-1 · Black wins", "st.resultDraw": "½-½ · Draw",
      ...
      "msg.engine.bootFailed": "The engine could not start — playing the computer, hints and analysis are unavailable for now. Try again; if it still fails, copy the diagnostics and report it.",
      "st.engineDown": "engine could not start",
      "side.white": "White",
      "side.black": "Black",
      "msg.export.cancelled": "Export cancelled",
      "msg.export.done": "Exported ",
      "msg.export.doneAt": "Exported to ",
      "msg.export.inDownloads": " \u2014 in your downloads folder",
      "msg.export.restrictedCopied": "Export unavailable \u2014 PGN copied to the clipboard",
      "msg.export.bridgeCopied": "No file dialog available — copied to the clipboard instead", "msg.export.tooLargeCopied": "Too large to write as a file — copied to the clipboard instead", "msg.export.bridgeFailed": "No file dialog available; the picture was not saved",
      ...
      "stats.recentAcc": "Accuracy (last ", "stats.recentAccSuffix": ")", "stats.latest": "last ",
      ...
      "act.drillSource": "That game", "tip.drillSource": "Open the game this drill was mined from, stopped on that move",
      ...
      "rep.empty": "No repertoire yet: import a PGN with variations and each line becomes a drill.",
      "rep.lines": "Lines", "rep.bySide": "White {0} \u00b7 Black {1}", "rep.learnt": "Learnt {0}/{1}",
      "rep.gapsTitle": "Openings you play that the book says nothing about:",
      "rep.gapRecord": "{0:game|games} \u00b7 {1} lost",
      "rep.added": "{0} added ({1} already in the book)", "rep.addedNone": "All {0} were already in the book",
      "rep.dropped": "The book holds {0}; the {1} oldest dropped out",
      "rep.clearAsk": "Clear your own repertoire? The progress on it goes too.", "rep.clearTitle": "Clear the repertoire",
      "rep.skippedSetUp": "{0:game|games} skipped: a repertoire line runs from the starting position, and those start somewhere else",
      "rep.badGames": "Skipped {0:unreadable game|unreadable games}; the rest went in",
      "rep.clearOk": "Clear", "rep.cleared": "Repertoire cleared", "rep.unnamed": "Your own line",
      "pz.cat.rep": "Repertoire", "tip.cat.rep": "Your own repertoire: drill the lines you imported; step off them and it tells you what the book plays",
      "lib.names": "Your name in these games",
      "lib.namesHint": "Comma-separate several account names; case does not matter. Games where neither side is you are kept, they just do not count towards \u201Cyour\u201D numbers.",
      "lib.empty": "Import the games you played elsewhere; twenty analysed buy a diagnosis.",
      "lib.count": "{0:game|games}", "lib.claimed": "{0} yours", "lib.analysed": "{0} analysed",
      "lib.queued": "{0} queued",
      "lib.analyse": "Analyse the remaining {0}", "lib.pause": "Pause analysis",
      "lib.analyseEta": "Analyse the remaining {0} (about {1})", "lib.etaMin": "{0:minute|minutes}", "lib.etaHour": "{0} hours",
      "lib.working": "Analysing game {0} of {1} \u00B7 {2}",
      "lib.added": "Took in {0:game|games}; {1} already there", "lib.addedNone": "All {0} games in that file were already in the library",
      "lib.dropped": "The library holds {0}; the {1} oldest imports were pushed out",
      "lib.noneClaimed": "None of these are yours yet \u2014 put the name you play under in the field above",
      "lib.needMore": "{0} more games needed for a diagnosis ({1}/{2} analysed)",
      "lib.busy": "The engine is busy; import once this analysis pass is done",
      "lib.all": "All {0:game|games}", "lib.listTitle": "Game library",
      "lib.bySort": "Sort", "lib.sortNew": "Most recent", "lib.sortWorst": "My worst",
      "lib.listHint": "Open a game on the board \u2014 its analysis comes with it, the engine does not run again.",
      "lib.clearPick": "Clear filter",
      ...
      "lib.minedDone": "{0:game|games} analysed, {1:drill|drills} banked",
      "lib.unplayable": "{0:game|games} could not be replayed and were skipped \u2014 the PGN itself does not hold up",
      "lib.deepen": "Deeper", "tip.libDeepen": "Re-analyse this game at 400ms instead of 200, and correct the drills it produced",
      "lib.deepable": "{0:game|games} were scanned at 200ms and can be looked at more deeply",
      "lib.deepWorking": "Looking deeper at {0} \u2026 {1}",
      "lib.deepDone": "{0}, deeper pass: {1} withdrawn, {2} re-answered, {3} added",
      "lib.deepCut": "That game was not finished \u2014 its earlier analysis is left as it was",
      "lib.passCut": "The engine gave no evaluation twice, so the pass stopped here; the unfinished game is left as it was",
      "diag.title": "Library diagnosis",
      "diag.from": "{0} analysed games, all read from your side of the board",
      "diag.record": "Record", "diag.wld": "{0}W {1}L {2}D",
      "diag.acc": "Average accuracy", "diag.phase": "By phase", "diag.phaseOpening": "Opening (first {0} moves)",
      "diag.phaseMiddle": "Middlegame", "diag.phaseEnd": "Endgame",
      "diag.acpl": "{0} cp/move", "diag.badRate": "{0}% mistakes",
      "diag.weakest": "Work on the {0}: you lose {1} centipawns a move there, {2} more than in your best phase.",
      "diag.noWeakest": "The three phases are close; none of them is clearly holding you back.",
      "diag.peak": "Mistakes cluster at move {0} \u2014 {1} of your games went wrong there.",
      "diag.motifs": "What catches you", "diag.motifN": "{0:time|times}",
      "diag.ecos": "By opening", "diag.ecoRow": "{0:game|games} \u00B7 {1}% score",
      "diag.openThese": "Open these games",
      "diag.chartTop": "max {0}",
      "diag.peakRange": "The chart covers moves {0}\u2013{1}; its tallest bar is {2} games.",
      "diag.legendWin": "Won", "diag.legendDraw": "Drawn", "diag.legendLoss": "Lost",
      "diag.chartPhase": "Centipawns lost per move in the opening, middlegame and endgame",
      "diag.chartPeak": "How your mistakes are spread across move numbers",
      "diag.chartEco": "Wins, draws and losses in each opening",
      ...
      "dlg.loadLib": "Opening this library game replaces the current game. Continue?",
      "dlg.loadLibTitle": "Open from the library", "dlg.loadLibOk": "Open",
      "pz.tier": "Difficulty", "pz.all": "All", "pz.easy": "Easy", "pz.mid": "Medium", "pz.hard": "Hard",
      "pz.noneInTier": "No puzzles at this difficulty",
      "pz.fromLesson": "Practising: {0}",
      "pz.tierCleared": "Difficulty filter cleared so this puzzle can show",
      ...
      "ed.clear": "Empty board", "ed.reset": "Initial position",
      ...
      "live.targets": "legal moves", "live.cleared": "Selection cleared", "live.start": "Back to the start",
      ...
      "tip.accuracy": "From the change in win probability on each move — the same measure online sites call accuracy",
      ...
      "tip.lesson.practice": "Puzzles on the same motif — the lesson only drilled it once",
    ...
    ja: {
      ...
      "about.licenseText": "GPLv3 —— 自由ソフトウェア。ソースコードは各リリースに付属", "about.creditsText": "Stockfish 19（GPLv3）· chess.js（BSD-2）· cburnett 駒セット（GFDL / BSD / GPL / CC BY-SA 3.0 の複数ライセンス）· Merida 駒セット（Armando Hernandez Marroquin、GPLv2+）· lichess chess-openings（CC0）· 木製の効果音は本プロジェクト製（物理モデルで実時間合成、GPLv3）· Lucide アイコン（ISC。うち 10 個は Feather 由来で MIT）",
      // 7.7 (v7-7-plan §2–§4, §7): the result card, the puzzle feedback card,
      // the lesson dots and the tool row's tooltips
      "go.analyse": "この対局を解析",
      "go.again": "もう一局",
      ...
      "go.r.mate": "チェックメイト",
      "go.r.flag": "{0}の時間切れ",
      "go.r.flagDraw": "時間切れ · 相手にメイトする駒がない",
      "go.r.resign": "{0}の投了",
      "go.r.agreed": "合意で引き分け",
      "go.r.threefold": "引き分け宣言 · 同一局面 3 回",
      "go.r.fifty": "引き分け宣言 · 50 手のあいだ駒取りもポーンの動きもなし",
      "go.r.stalemate": "ステイルメイト",
      "go.r.insufficient": "双方ともメイトできる駒がない",
      "go.r.fivefold": "同一局面 5 回",
      "go.r.seventyfive": "75 手のあいだ駒取りもポーンの動きもなし",
      "go.r.file": "棋譜に記録された結果",
      "pz.fb.best": "最善手！",
      "pz.fb.keepGoing": "正解、続けましょう",
      "pz.fb.retry": "もう一度考えよう",
      "pz.fb.streak": "{0} 問連続正解",
      ...
      "msg.menuLang.restart": "メニューの言語は次回起動時に反映されます", "app.title": "チェス",
      "side.volume": "ボリューム", "tip.volume": "効果音の音量", "side.soundSet": "サウンド", "tip.soundSet": "木製：木の駒を木の盤に置く音。クラシック：7.7 より前の合成音", "soundSet.wood": "木製", "soundSet.classic": "クラシック", "side.coords": "座標", "tip.coords": "盤に a–h と 1–8 を表示", "side.coordsAt": "座標の位置", "coords.out": "盤外", "coords.in": "盤内", "side.softMark": "疑問符の表示", "tip.softMark": "検討で ?! を表示する —— 同じ局面を二度調べても一致するのは約半分なので既定では非表示", "side.blindfold": "目隠しチェス", "tip.blindfold": "駒を描かず印だけ描く —— 記憶で指す", "side.engineArrows": "エンジンの矢印", "tip.engineArrows": "常時解析と検討の間、エンジンの上位三つの読み筋の初手を盤上に矢印で表示します",
      "msg.blind.on": "目隠し：駒を隠しました", "msg.blind.off": "駒を表示しました",
      "side.engine": "エンジン", "side.hash": "ハッシュ表", "tip.hash": "エンジンのハッシュ表サイズ（MB）", "side.multipv": "解析ライン数", "tip.multipv": "検討と常時解析で同時に示す変化の本数",
      "tip.learning.export": "ミス帳・復習キュー・レッスンの進度・成績をひとつのファイルに保存", "tip.learning.import": "書き出したファイルを統合して戻す。この端末の進度は上書きされません",
      "dlg.exportLearning": "学習データを書き出す", "dlg.importLearning": "学習データを読み込む：この端末の進度と統合し、どちらも上書きしません。",
      "msg.learning.badFile": "このアプリが書き出した学習データではありません", "msg.learning.imported": "統合しました —— ミス帳は現在 {0} 問",
      ...
      "msg.storage.corrupt": "読み出せない記録があります（{0}）。そのまま退避し、上書きはしていません。設定の「すべてのデータ → 書き出し」に含まれます。",
      "msg.fault.happened": "問題が発生しました —— 現在の局面は保存済みです。再発する場合は診断情報をコピーして報告してください。", "msg.fault.copy": "診断情報をコピー", "msg.fault.copied": "診断情報をコピーしました",
      "lang.name": "日本語",
      // first-run onboarding (ob.*)
      "ob.title": "どこから始めますか？",
      ...
      "rv.turningPoint": "分岐点：第 {0} 手目、{1} の {2}、勝率が {3} ポイント下がった —— タップで移動",
      "rv.turningPointPlain": "分岐点：第 {0} 手目、{1} の {2}、勝率が {3} ポイント下がった",
      "rv.jumpTip": "この手のあとの局面へ移動",
      "rv.bank": "この一手をマイ失着に収録",
      "rv.bankTip": "この転換点を自動収録と同じ規則で「マイ失着」に追加します",
      "ex.mate1": "{0} の一手メイトを逃した",
      "ex.mateN": "{0} から始まる{1}手メイトを逃した",
      "ex.allowsMate": "{0} から始まる{1}手メイトを許した",
      "ex.allowsMate1": "{0} の一手メイトを許した",
      "ex.motifLoss": "{0}（{1}）を見落とし、{2}を失う",
      "ex.motif": "{0}（{1}）を見落とした",
      "ex.forkHits": "{0}（{1}）を見落とし、{2}と{3}を同時に狙われる",
      "ex.loss": "{0} のあと{1}を失う",
      "ex.betterMotif": "{0}（{1}）が良かった",
      "ex.better": "{0} が良かった",
      "rv.mistakes": "悪手",
      "rv.retry": "もう一度",
      "rt.ask": "もう一度：第 {0} 手目、{1}の最善手は？",
      "rt.checking": "エンジンがこの手を判定中…",
      "rt.right": "正解",
      "rt.wrong": "不正解",
      "rt.best": "エンジンの最善：{0}",
      "rt.again": "もう一度指す",
      "rt.back": "振り返りに戻る",
      "rt.noEngine": "エンジンの準備ができていないため、この手を判定できません",
      "rv.banked": "収録しました · 正解は {0}",
      "rv.bankDup": "この一手はすでにマイ失着にあります",
      "rv.bankNone": "エンジンの選択は実戦と同じです —— 練習の余地がありません",
      ...
      "ntf.libraryTitle": "棋譜ライブラリ",
      "ntf.libraryBody": "{1} 局中 {0} 局を解析",
      "ntf.libraryDone": "{0} 局の解析が終わりました",
      ...
      "mm.blunder": "直前の {0} は大悪手かもしれません —— Z で待ったして考え直せます",
      "mm.plies": "{0} 手",
      ...
      "msg.pgnLocked": "解析中です。いま棋譜を変えると解析が無効になります。先に解析を止めてください",
      ...
      "pz.cat.mine": "マイ失着",
      "tip.cat.mine": "解析で ?? が付いた自分の失着を並べ直し、正しい一手を探します",
      "pz.goalMine": "実戦では {0} と指しました —— より強い一手を探してください",
      "pz.mineCost": "損失 {0} ポーン",
      "pz.mineName": "失着 {0} · {1} 手目",
      "pz.mine.repeat": "それこそ実戦で形勢を失った一手です",
      "pz.mine.stronger": "ここではエンジンにより強い一手があります",
      "pz.mine.whyLoss": "実戦の {0} は約 {1} 点の損でした。", "pz.mine.whyLine": "{0} のあとはおおむね {1} と進みます。",
      "pz.mine.alsoFine": "{0} でも成立します —— 最善手との差は {1} 点だけ", "pz.mine.altCost": "最善手より {0} 点の損",
      "pz.doneMine": "取り返しました",
      "msg.mined": "失着 {0} 件をドリルに収録",
      "msg.minesRevised": "{0} 問の答えを訂正", "msg.minesWithdrawn": "{0} 問を撤回 —— この深さでは大悪手ではありません",
      "daily.btn": "今日のトレーニング",
      "tip.daily": "復習の残り・失着・弱点・レッスンの進み具合からこの一回分を組みます",
      "daily.of": "ステップ {0}/{1}",
      "daily.review": "まず復習を {0} 問",
      "daily.mine": "マイ失着を {0} 問",
      "daily.weak": "弱点「{0}」を 2 問",
      "daily.motif": "テーマ「{0}」を 2 問", "daily.motifDone": "このテーマの問題はすべて解きました —— 別の練習へ",
      "daily.lesson": "新しいレッスンを 1 つ学ぶ",
      "daily.op": "定跡を 1 本",
      "daily.lib": "ライブラリの未解析 {0} 局を解析する",
      "daily.game": "1 局指す",
      "daily.rest": "残りも未着手もありません —— 自由練習か、そのまま 1 局どうぞ",
      "daily.begin": "この回は {0} ステップ，最初から始めます",
      "daily.done": "本日のトレーニング完了",
      "daily.streak": "連続 {0} 日",
      "daily.planAria": "このセッションの手順",
      "daily.why.review": "復習の期限", "daily.why.mine": "あなたが間違えた局面", "daily.why.weak": "成績が最も弱い分野",
      "daily.why.lesson": "次のレッスン", "daily.why.op": "まだ覚えていない定跡", "daily.why.game": "今日はまだ対局していない",
      "daily.why.motif": "繰り返し間違えている戦術テーマ",
      "side.trend": "上達",
      "aria.trendAcc": "正確度の推移",
      "tip.trendAcc": "最近解析した対局の正確度を時系列で表示します",
      "trend.row": "今週の正答率 {0} · 先週 {1}",
      "trend.rowNew": "今週の正答率 {0}",
      "trend.rowPrev": "先週の正答率 {0} · 今週はまだ未回答",
      "trend.mines": "今週の収録 {0} · 取り返し {1}",
      "pz.cat.real": "実戦",
      "tip.real": "実戦の戦術：20 枚以上の中盤で、駒得できる手は一つだけ",
      "pz.cat.def": "受け", "pz.cat.draw": "引き分け狙い",
      "pz.smart": "おすすめの一問", "tip.puzzle.smart": "復習の残りとミス率から次の一問を選ぶ",
      "pz.smart.review": "まず復習：あと {0} 問",
      "pz.smart.weak": "「{0}」が最もミスの多い分野",
      ...
      "study.part": "名局を読む", "study.head": "棋譜を読む", "study.intro": "{0}、{1} 年 · {2} · 結果 {3}。← → で一手ずつ読み進めると注釈が現れます。いつでも別の手を試せます。", "study.noNote": "（この手に注釈はありません）", "study.of": "{0} 手目",
      ...
      "side.pieces": "駒のデザイン", "pieces.cburnett": "標準", "pieces.merida": "メリダ",
      ...
      "ach.more": "あと {0} 件", "ach.less": "たたむ",
      "rec.emptyLead": "このページには指した記録が残ります——成績、各局の棋譜、十五個の実績。まだ空です。下の三つが、それぞれ最初の一つを開けます。",
      "rec.goLearn": "第 1 課を受ける", "rec.goPuzzle": "戦術問題を 1 問解く", "rec.goPlay": "エンジンと 1 局指す",
      "rec.unlocks": "「{0}」を解除", "rec.winUnlocks": "勝てば「{0}」を解除",
      "diff.beginner": "やさしい", "diff.easy": "初級", "diff.normal": "中級",
      "diff.casual": "お気軽",
      "tip.casual": "入門より正確ですが、まだ間違えます —— 勝てるようになったら次はここ",
      "diff.hard": "上級", "diff.extreme": "無制限",
      "color.white": "白", "color.black": "黒", "color.random": "ランダム", "ng.title": "新しい対局", "ng.endsCurrent": "いまの対局は終了します", "ng.start": "開始", "ng.pvpColor": "手前側の色",
      "clock.off": "時計なし",
      "theme.wood": "ウッド", "theme.night": "ナイト", "theme.day": "デイ", "theme.notebook": "ペーパー",
      "act.analyze": "解析", "act.deep": "精密解析", "act.stop": "中止", "act.retryHere": "指し直す",
      "act.live": "常時解析", "tip.live": "盤上の局面をエンジンが解析し続け、検討カーソルに追従します", "an.depth": "深さ", "an.win": "勝率", "an.line": "第 {0} 候補",
      "msg.premove.set": "先行入力 {0}", "msg.premove.dropped": "先行入力は無効になりました",
      ...
      "act.restart": "やり直す", "act.retry": "再試行", "act.demo": "お手本", "act.next": "次のレッスン",
      "act.practice": "続けて{0}問",
      "act.puzzleRetry": "やり直す", "act.puzzleNext": "次の問題",
      "turn.white": "白番", "turn.black": "黒番", "turn.check": "チェック！",
      "vs.white": "白", "vs.black": "黒", "vs.p1": "プレイヤー 1", "vs.p2": "プレイヤー 2",
      ...
      "st.result10": "1-0 · 白の勝ち", "st.result01": "0-1 · 黒の勝ち", "st.resultDraw": "½-½ · 引き分け",
      ...
      "msg.engine.bootFailed": "エンジンを起動できませんでした —— 対局・ヒント・解析は今は使えません。再試行してください。直らない場合は診断情報をコピーして報告してください。",
      "st.engineDown": "エンジンを起動できません",
      "side.white": "白",
      "side.black": "黒",
      "msg.export.cancelled": "書き出しを中止しました",
      "msg.export.done": "書き出しました ",
      "msg.export.doneAt": "書き出し先： ",
      "msg.export.inDownloads": " \u2014 ダウンロードフォルダーにあります",
      "msg.export.restrictedCopied": "書き出せないため PGN をクリップボードにコピーしました",
      "msg.export.bridgeCopied": "ファイルダイアログを使えません —— 内容をクリップボードにコピーしました", "msg.export.tooLargeCopied": "ファイルが大きすぎて書き込めません —— 内容をクリップボードにコピーしました", "msg.export.bridgeFailed": "ファイルダイアログを使えず、画像は保存されませんでした",
      ...
      "act.drillSource": "その一局へ", "tip.drillSource": "この問題を掘り出した一局を開き、その手で止めます",
      ...
      "rep.empty": "自分の定跡書はまだありません。変化付きの PGN を読み込むと、変化ごとに一問になります。",
      "rep.lines": "定跡の本数", "rep.bySide": "先手 {0} · 後手 {1}", "rep.learnt": "覚えた {0}/{1}",
      "rep.gapsTitle": "指しているのに定跡書にない開局：",
      "rep.gapRecord": "{0} 局 · 負け {1}",
      "rep.added": "{0} 本を追加（{1} 本はすでにありました）", "rep.addedNone": "この {0} 本はすべてすでに書にあります",
      "rep.dropped": "上限 {0} 本。古い {1} 本が外れました",
      "rep.clearAsk": "自分の定跡書を空にしますか？覚えた進捗も一緒に消えます。", "rep.clearTitle": "定跡書を空にする",
      "rep.skippedSetUp": "{0} 局を飛ばしました：定跡書は初期配置から始まる手順です。その局は別の局面から始まっています",
      "rep.badGames": "{0} 局は読めなかったので飛ばしました。残りは書に入れました",
      "rep.clearOk": "空にする", "rep.cleared": "定跡書を空にしました", "rep.unnamed": "自分の変化",
      "pz.cat.rep": "定跡書", "tip.cat.rep": "自分の定跡書：読み込んだ定跡を覚えます。外れたらその場で書の手を教えます",
      "lib.names": "棋譜での自分の名前",
      "lib.namesHint": "複数のアカウント名はコンマ区切り。大文字小文字は問いません。どちらも自分でない対局も残りますが、「あなたの」数字には入りません。",
      "lib.empty": "よそで指した対局を取り込み、二十局解析すると診断が出ます。",
      "lib.count": "全 {0} 局", "lib.claimed": "自分の対局 {0} 局", "lib.analysed": "解析済み {0} 局",
      "lib.queued": "解析待ち {0} 局",
      "lib.analyse": "残り {0} 局を解析", "lib.pause": "解析を一時停止",
      "lib.analyseEta": "残り {0} 局を解析（約 {1}）", "lib.etaMin": "{0} 分", "lib.etaHour": "{0} 時間",
      "lib.working": "{1} 局中 {0} 局目を解析中 · {2}",
      "lib.added": "{0} 局を取り込みました（重複 {1} 局は飛ばしました）", "lib.addedNone": "このファイルの {0} 局はすべてライブラリにあります",
      "lib.dropped": "上限 {0} 局のため、古い {1} 局が押し出されました",
      "lib.noneClaimed": "自分の対局が一つも見つかりません — 上の欄に棋譜での名前を入れてください",
      "lib.needMore": "診断まであと {0} 局（解析済み {1}/{2}）",
      "lib.all": "全 {0} 局", "lib.listTitle": "棋譜ライブラリ",
      "lib.bySort": "並び順", "lib.sortNew": "最近の取り込み", "lib.sortWorst": "出来の悪い順",
      "lib.listHint": "一局を選ぶと盤に並びます。解析結果もそのまま付いてくるので、エンジンは走り直しません。",
      "lib.clearPick": "絞り込みを解除",
      "lib.rowAcc": "精度 {0}%", "lib.rowBad": "失着 {0} 手",
      "lib.rowPending": "未解析", "lib.rowUnplayable": "着手を再現できません",
      "lib.unknownFoe": "対戦相手不明", "lib.loaded": "ライブラリから読み込みました · {0}",
      "lib.minedDone": "{0} 局を解析し、{1} 問を錬成しました",
      "lib.busy": "エンジンが動いています。この解析が終わってから取り込んでください",
      "lib.unplayable": "{0} 局は着手を再現できず、飛ばしました（棋譜そのものの問題で、解析の失敗ではありません）",
      "lib.deepen": "もう一段深く", "tip.libDeepen": "この一局を 200 ではなく 400 ミリ秒で解析し直し、そこから出た問題も直します",
      "lib.deepable": "{0} 局は 200 ミリ秒の速読み解析です。もう一段深く見られます",
      "lib.deepWorking": "{0} を深く解析中 …… {1}",
      "lib.deepDone": "{0} の深い解析が完了：取り消し {1} 問・答え変更 {2} 問・新規 {3} 問",
      "lib.deepCut": "この一局は解析を終えていません。元の解析はそのままです",
      "lib.passCut": "エンジンが二度とも評価を返さなかったので、解析をここで止めました。途中の一局はそのままです",
      "diag.title": "ライブラリ診断",
      "diag.from": "解析済み {0} 局、すべてあなたの側から見た数字です",
      "diag.record": "成績", "diag.wld": "{0} 勝 {1} 敗 {2} 分",
      "diag.acc": "平均精度", "diag.phase": "局面別", "diag.phaseOpening": "序盤（最初の {0} 手）",
      "diag.phaseMiddle": "中盤", "diag.phaseEnd": "終盤",
      "diag.acpl": "1 手あたり {0} センチポーン", "diag.badRate": "失着率 {0}%",
      "diag.weakest": "鍛えるべきは{0}。1 手あたり {1} センチポーン失っており、最も良い局面より {2} 多く損しています。",
      "diag.noWeakest": "三つの局面に大きな差はありません。",
      "diag.openThese": "この対局群を開く",
      "diag.chartTop": "最大 {0}",
      "diag.peakRange": "このグラフは {0}\u2013{1} 手目を表示しています。最も高い棒は {2} 局です。",
      "diag.legendWin": "勝ち", "diag.legendDraw": "分け", "diag.legendLoss": "負け",
      "diag.chartPhase": "序盤・中盤・終盤それぞれの 1 手あたりの損失",
      "diag.chartPeak": "失着が何手目に集中しているか",
      "diag.chartEco": "定跡ごとの勝ち・分け・負け",
      "diag.pickMotif": "「{0}」にやられた対局だけ",
      "diag.pickEco": "{0} の対局だけ",
      "diag.pickPeak": "{0} 手目で崩れた対局だけ",
      "diag.peak": "失着が集中するのは {0} 手目。{1} 局がここで崩れています。",
      "diag.motifs": "やられている戦術", "diag.motifN": "{0} 回",
      "diag.ecos": "序盤別成績", "diag.ecoRow": "{0} 局 · 得点率 {1}%",
      ...
      "keys.retry": "今の一問をやり直す",
      "keys.next": "次の問題", "keys.lessonHint": "このレッスンのヒント", "keys.answer": "答えを見る",
      ...
      "dlg.loadLib": "ライブラリのこの対局を開くと現在の対局が置き換わります。続けますか？",
      "dlg.loadLibTitle": "ライブラリから開く", "dlg.loadLibOk": "開く",
      "pz.tier": "難易度", "pz.all": "すべて", "pz.easy": "やさしい", "pz.mid": "ふつう", "pz.hard": "むずかしい",
      "pz.noneInTier": "この難易度の問題はありません",
      "pz.fromLesson": "続けて練習：{0}",
      "pz.tierCleared": "この問題を表示するため難易度の絞り込みを解除しました",
      ...
      "live.targets": "手が指せます", "live.cleared": "選択を解除しました", "live.start": "初期局面に戻りました",
      ...
      "tip.accuracy": "各手の勝率変化から換算しています。オンラインサイトの「正確度」と同じ尺度です",
      ...
      "tip.lesson.practice": "同じテーマの問題へ。レッスンでは一度しか練習していません",
