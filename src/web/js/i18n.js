 ...
 */
  const DICT = {
    "zh-CN": {
      ...
      "about.licenseText": "GPLv3 —— 自由软件，源码随发布提供", "about.creditsText": "Stockfish 19（GPLv3）· chess.js（BSD-2）· cburnett 棋子矢量（GFDL / BSD / GPL / CC BY-SA 3.0 多重许可）· Merida 棋子（Armando Hernandez Marroquin，GPLv2+）· lichess chess-openings（CC0）· 木质音效为本项目自制（物理模型实时合成，GPLv3）",
      ...
      "rep.empty": "还没有你自己的开局书。导一份带变着的 PGN 进来 —— 主线和每一条变着都会变成一道题。",
      ...
      "lib.empty": "把你在别处下的棋批量导入进来 —— 一个 PGN 文件里有多少局就收多少局，逐局离线分析，攒够二十局给一份诊断。",
    ...
    en: {
      ...
      "about.licenseText": "GPLv3 — free software; the source ships with every release", "about.creditsText": "Stockfish 19 (GPLv3) · chess.js (BSD-2) · cburnett piece set (multi-licensed GFDL / BSD / GPL / CC BY-SA 3.0) · Merida piece set (Armando Hernandez Marroquin, GPLv2+) · lichess chess-openings (CC0) · wooden sound set made for this project (rendered from a physical model, GPLv3)",
      ...
      "rep.empty": "No repertoire of your own yet. Import a PGN with variations \u2014 the mainline and every variation in it becomes a drill.",
      ...
      "lib.empty": "Bring in the games you played elsewhere \u2014 every game in the PGN file, not one of them, analysed offline one at a time. Twenty analysed games buys a diagnosis.",
    ...
    ja: {
      ...
      "about.licenseText": "GPLv3 —— 自由ソフトウェア。ソースコードは各リリースに付属", "about.creditsText": "Stockfish 19（GPLv3）· chess.js（BSD-2）· cburnett 駒セット（GFDL / BSD / GPL / CC BY-SA 3.0 の複数ライセンス）· Merida 駒セット（Armando Hernandez Marroquin、GPLv2+）· lichess chess-openings（CC0）· 木製の効果音は本プロジェクト製（物理モデルで実時間合成、GPLv3）",
      ...
      "rep.empty": "自分の定跡書はまだありません。変化付きの PGN を読み込むと、本線も変化もそれぞれ一問になります。",
      ...
      "lib.empty": "よそで指した対局をまとめて取り込みます。PGN ファイルの全局をそのまま、一局ずつオフラインで解析し、二十局たまれば診断が出ます。",
