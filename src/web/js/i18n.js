...
(function (global) {
  const DICT = {
    "zh-CN": {
      ...
      "ob.newSub": "51 课互动教程:认棋盘 → 六种走法 → 吃子与战术 → 规则与杀法 → 中局思路 → 残局基础与实战",
    ...
    en: {
      ...
      "ob.newSub": "51 interactive lessons: the board \u2192 how the pieces move \u2192 captures and tactics \u2192 rules and mates \u2192 middlegame thinking \u2192 endgame basics and technique",
    ...
    ja: {
      ...
      "ob.newSub": "51 の対話式レッスン:盤の見方 → 駒の動かし方 → 駒取りと戦術 → ルールとメイト → 中盤の考え方 → エンドゲームの基本と実戦",
