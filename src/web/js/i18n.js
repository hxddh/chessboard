 ...
 */
  const DICT = {
    ...
    en: {
      ...
      "trend.row": "this week {0} · last week {1}",
      "trend.rowNew": "this week {0}",
      "trend.rowPrev": "last week {0} · none answered yet this week",
