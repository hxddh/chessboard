 ...
 */
  const DICT = {
    "zh-CN": {
      ...
      "msg.export.bridgeCopied": "文件对话框不可用 —— 内容已复制到剪贴板", "msg.export.bridgeFailed": "文件对话框不可用，图片没有保存",
    ...
    en: {
      ...
      "msg.export.bridgeCopied": "No file dialog available — copied to the clipboard instead", "msg.export.bridgeFailed": "No file dialog available; the picture was not saved",
    ...
    ja: {
      ...
      "msg.export.bridgeCopied": "ファイルダイアログを使えません —— 内容をクリップボードにコピーしました", "msg.export.bridgeFailed": "ファイルダイアログを使えず、画像は保存されませんでした",
