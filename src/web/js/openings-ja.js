 ...
 */
  export const CHESS_OPENINGS_JA = {
    ...
    "queens-pawn-opening": "クイーンズ・ポーン・ゲーム",
    ...
    "london-system-vs-kings-indian": "ロンドン・システム（対キングズ・インディアン）",
    ...
    // B — 1.e4（フレンチ以外の半オープン）
    "kings-pawn-opening": "キングズ・ポーン・ゲーム",
    ...
    "caro-kann-advance": "カロ・カン・ディフェンス：アドバンス本流",
    "caro-kann-panov-attack": "カロ・カン・ディフェンス：パノフ・アタック",
    "caro-kann-classical-short-castles": "カロ・カン・ディフェンス：クラシカル・短いキャスリング",
    "caro-kann-classical": "カロ・カン・ディフェンス：クラシカル本流",
    ...
    "russian-petrov-defense": "ペトロフ・ディフェンス",
    ...
    "petrov-defence": "ペトロフ・ディフェンス：クラシカル本流",
    "scotch-gambit": "スコッチ・ギャンビット",
    "scotch-game-classical": "スコッチ・ゲーム：クラシカル変化",
    "four-knights-game-main": "フォー・ナイツ・ゲーム：スパニッシュ対称変化",
    "four-knights-scotch": "フォー・ナイツ・ゲーム：スコッチ変化",
    "nimzo-larsen-main": "ニムゾ・ラーセン攻撃・本流",
    "torre-attack": "トーレ・アタック",
    "scandinavian-defence-qd6": "スカンジナビア防御・現代型Qd6",
    "london-jobava": "ヨバヴァ・ロンドン・システム",
    "vienna-game-mieses": "ウィーン・ゲーム・ミーゼス変化",
    "caro-kann-exchange-main": "カロ・カン・ディフェンス：交換本流",
    "bogo-indian-defence": "ボゴ・インディアン防御",
    ...
    "kings-indian-fianchetto": "キングズ・インディアン・ディフェンス：フィアンケット変化",
  ...
  export const CHESS_OPENING_IDEAS_JA = {
    ...
    "four-knights-scotch":
      "フォー・ナイツで最も暗記の少ない白の選択。d4 で中央を交換し、黒は d5 のポーンと同時に孤立化しやすい形を抱える。双方とも自分が何を指しているか分かっている。",
    "nimzo-larsen-main":
      "まず b2 のビショップを据え、中央の突き方は後で決める。形を決める義務をすべて相手に押しつける。暗記する手順はなく、あるのは配置だけ \u2014 だから覚えるのが安い。",
    "torre-attack":
      "Bg5 でナイトに睨みを利かせ、c3+e3 で崩れにくい骨組みを作る。ロンドンと同じ一族：記憶より構造。",
    "scandinavian-defence-qd6":
      "クイーンは a5 ではなく d6 へ。e5 を見張り、c7 にも移れて、...c6/...e6 のカロ・カン風の砦の余地も残す。現代スカンジナビアの標準解。",
    "london-jobava":
      "ロンドンのビショップと Nc3 の組み合わせ。c ポーンを塞ぐ代償に、Nb5 の跳躍や f3-g4 の突撃という直接的な攻めを手に入れる。ロンドン一族で最も鋭い一員。",
    "vienna-game-mieses":
      "白は d5 を争わない。ナイト交換のあと、g2 のビショップと半開きの b 筋が長期的な主題になる。静かだが、一手一手が中盤への布石。",
    "caro-kann-exchange-main":
      "交換変化の要点はすべて b7 にある。Bd3 と Qb3 で黒のクイーンを c8 の守りに縛りつけ、白が先に駒組みを終える。対称形ではテンポこそが全財産。",
    "bogo-indian-defence":
      "一度のチェックでビショップを d2 に誘い、ゆっくり交換する。黒はビショップペアを手放す代わりに、白が崩しにくい e5-d6 の砦を手に入れる。",
